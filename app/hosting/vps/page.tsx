  ...
  const plans = [
    {
      ...
      price: "$19.99",
      period: "/month",
      features: ["2 CPU Cores", "4GB RAM", "50GB SSD Storage", "2TB Bandwidth", "Root Access", "24/7 Support"],
      popular: false,
    },
    {
      name: "VPS Plus",
    ...
    },
    {
      ...
      price: "$79.99",
      period: "/month",
      features: ["8 CPU Cores", "16GB RAM", "200GB SSD Storage", "8TB Bandwidth", "Root Access", "24/7 VIP Support"],
      popular: false,
    },
  ]
      ...
      <section className="pt-32 pb-20 relative z-10">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="mb-6 bg-green-500/20 text-green-400 border-green-500/30">VPS Hosting</Badge>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Get dedicated resources and full control with our scalable VPS hosting plans.
            </p>
          </div>
        </div>
      </section>
