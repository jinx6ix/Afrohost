      ...
      <section className="pt-32 pb-20 relative z-10">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="mb-6 bg-blue-500/20 text-blue-400 border-blue-500/30">Shared Hosting</Badge>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Perfect for beginners and small websites. Get started with reliable hosting at an affordable price.
            </p>
          </div>
        </div>
      </section>
